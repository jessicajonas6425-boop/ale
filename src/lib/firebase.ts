...
export const INITIAL_BANCOS: Omit<Banco, 'id'>[] = [
  { name: 'Crefisa', code: '069', loginUrl: 'https://app1.gerencialcredito.com.br/CREFISA/#xd_co_f=ZGNhOWU3NDktOTU5Ni00YjBkLThlMDctMTQyYTY2NTlhN2U5~', status: 'ATIVO', position: 1, certificationRequired: true, category: 'Consignado & Crédito' },
  { name: 'Unno', code: '901', loginUrl: 'https://login.unnotech.com.br/', status: 'ATIVO', position: 2, certificationRequired: false, category: 'Consignado & FGTS' },
  { name: 'Eccor', code: '902', loginUrl: 'https://app.eccor.io/login', status: 'ATIVO', position: 3, certificationRequired: false, category: 'Plataforma Multibancos' },
  { name: 'Prata', code: '903', loginUrl: 'https://admin.bancoprata.com.br/', status: 'ATIVO', position: 4, certificationRequired: true, category: 'Consignado & Cartão' },
  { name: 'Novo Saque', code: '904', loginUrl: 'https://sistema.novosaque.com.br/admin/users', status: 'ATIVO', position: 5, certificationRequired: false, category: 'Antecipação FGTS' },
  { name: 'Presença Bank', code: '905', loginUrl: 'https://portal.presencabank.com.br/sign-in', status: 'ATIVO', position: 6, certificationRequired: true, category: 'Consignado & Financiamento' },
  { name: 'DSV', code: '906', loginUrl: 'https://app.dsvdigi.com.br/', status: 'ATIVO', position: 7, certificationRequired: false, category: 'Digitação & Esteira' },
  { name: 'Lotus', code: '907', loginUrl: 'https://app.lotusmais.com.br/fgts/new', status: 'ATIVO', position: 8, certificationRequired: false, category: 'FGTS Saque Aniversário' },
  { name: 'Vctex', code: '908', loginUrl: 'https://www.appvctex.com.br/login', status: 'ATIVO', position: 9, certificationRequired: false, category: 'Esteira Digital' },
  { name: 'Icred', code: '909', loginUrl: 'https://corban.icred.digital/login', status: 'ATIVO', position: 10, certificationRequired: true, category: 'Corban Digital & Crédito' },
  { name: 'DREXPIX', code: '910', loginUrl: 'https://app.drexpix.tech/login', status: 'ATIVO', position: 11, certificationRequired: false, category: 'Antecipação Pix & FGTS' },
  { name: 'PH Tech', code: '911', loginUrl: 'https://phtech.uy3.com.br/login', status: 'ATIVO', position: 12, certificationRequired: false, category: 'Tecnologia & Crédito' },
  { name: 'V8', code: '912', loginUrl: 'https://app.v8sistema.com/', status: 'ATIVO', position: 13, certificationRequired: false, category: 'Sistema Consignado' },
  { name: 'Top mais Top', code: '913', loginUrl: 'https://app.topmaistop.com.br/', status: 'ATIVO', position: 14, certificationRequired: false, category: 'Consignado & Promotora' },
  { name: 'Fintech do Corban', code: '914', loginUrl: 'https://fintechdocorban.nossafintech.com.br/session/login', status: 'ATIVO', position: 15, certificationRequired: false, category: 'Plataforma Fintech' },
  { name: 'Hub', code: '915', loginUrl: 'https://fgts.hubcredito.com.br/login', status: 'ATIVO', position: 16, certificationRequired: false, category: 'Antecipação FGTS' },
  { name: 'Hand+', code: '916', loginUrl: 'https://app.handbank.com.br/', status: 'ATIVO', position: 17, certificationRequired: false, category: 'HandBank Consignado' },
  { name: 'Finanto', code: '917', loginUrl: 'https://finanto.joinbank.com.br/sign-in?redirectURL=%2Fmain', status: 'ATIVO', position: 18, certificationRequired: false, category: 'JoinBank & Finanto' },
];
